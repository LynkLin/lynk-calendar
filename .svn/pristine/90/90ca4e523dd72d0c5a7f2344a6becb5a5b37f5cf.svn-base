...
public class JCalendar extends JPanel implements PropertyChangeListener {
	...
	public static final int NULL_BUTTON_CLICK = -3;
	...
	private final String defaultLeftButtonText = "Left";
	private final String defaultRightButtonText = "Right";
	...
	public JCalendar(Date date, Locale locale, boolean monthSpinner,
		...
		leftButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dayChooser.firePropertyChange("day", 0, LEFT_BUTTON_CLICK);
			}
		});
		...
		rightButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dayChooser.firePropertyChange("day", 0, RIGHT_BUTTON_CLICK);
			}
		});
		...
		nullDateButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dayChooser.firePropertyChange("day", 0, NULL_BUTTON_CLICK);
			}
		});
	...
	/**
	 * Sets the Right button visible.
	 * 
	 * @param isRightButtonVisible
	 *            true, is the Null Date button shall be visible.
	 */
	public void setRightButtonVisible(boolean isRightButtonVisible) {
		this.isRightButtonVisible = isRightButtonVisible;
		relayoutSpecialButtonPanel();
	}
	 ...
	 */
	public boolean isExpLongButtonVisible() {
	...
	private void relayoutSpecialButtonPanel() {
		...
		if (isLeftButtonVisible) {
			...
			if (text == null) {
				text = defaultLeftButtonText;
			}
			leftButton.setText(text);
			specialButtonPanel.add(leftButton);
			buttonCount++;
		}
		if (isRightButtonVisible) {
			...
			if (text == null) {
				text = defaultRightButtonText;
			}
			rightButton.setText(text);
			specialButtonPanel.add(rightButton);
			buttonCount++;
		}
		...
		specialButtonPanel.setVisible(isRightButtonVisible
				|| isLeftButtonVisible || isNullDateButtonVisible
	...
	/**
	 * @return the text of the Left button
	 */
	...
	public void setLeftButtonText(String leftButtonText) {
		if (leftButtonText != null & leftButtonText.trim().length() == 0) {
	...
	/**
	 * @return the text of the right button
	 */
